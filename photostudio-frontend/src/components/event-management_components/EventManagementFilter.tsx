...
onUserNameChange: (term: string | undefined) => void
...
export function EventRequestManagementFilterBar({
    searchTerm,
    onSearchChange,
    userName,
    onUserNameChange,
...
const hasActiveFilters = searchTerm !== undefined || selectedStatus !== undefined || dateFrom !== undefined || dateTo !== undefined || userName !== undefined
